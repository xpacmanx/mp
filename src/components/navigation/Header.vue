        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/" class="rounded-md bg-lime-300 px-3 py-2 text-sm font-medium text-gray-950 hover:text-gray-600 visited:text-gray-950" aria-current="page">Сервис поставок</a>
              <a href="/ads" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-lime-300 hover:text-gray-950">Реклама</a>
            </div>
          </div>
        </div>
